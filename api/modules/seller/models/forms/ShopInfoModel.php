...
class ShopInfoModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['id','shop_name', 'contact_name','phone','detail','lat','lng','address','city',  'business_time','post_start_time','post_end_time','post_time',],'string','on' => [ 'default','update']],
            [['merchant_id','post_status','on_sale','status',  ], 'integer','on' => [ 'default','update']],
            [['back_img'  ], 'string','on' => [ 'default','update']],
            [['front_img','logo'], 'safe','on' => [ 'default','update']],
