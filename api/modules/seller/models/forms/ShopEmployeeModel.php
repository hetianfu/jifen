...
class ShopEmployeeModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['merchant_id','shop_id','account'],'required','on' => [ 'default' ]],
            ...
            [['id','mp_send_msg','sex' ,'sort','status' ], 'integer','on' => [ 'default','update']],
        ], $rules);
    }

    public function fields(){
        $fields = parent::fields();
        isset($this->shopInfo)&&$fields['shopInfo']='shopInfo';
    ...
    {
        return $this->hasOne(ShopInfoModel::class, ['id' => 'shop_id'])->select(['id', 'shop_name', 'address' ]);
