...
class PinkModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['total_num','currency_num','product_id', 'end_time','status'], 'integer','on' => [ 'default','update']],
    ...
    public function fields(){
        ...
        !empty($this->product_snap)&&$fields['partakeList']='partakeList';
        !empty($this->product_snap)&&$fields['productSnap']=function (){
    ...
    public function  getUserInfo(){
        return $this->hasOne( UserInfoModel::class,['id'=>'user_id'])->select(['id','head_img','nick_name','telephone' ]);
    }
