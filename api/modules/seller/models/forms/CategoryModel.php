 ...
 * @property int  $status  分类状态0显示  -1不显示;
...
class CategoryModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['name','status',],'required','on' => [ 'default' ]],
            [['name' ,'merchant_id','brand_id','brand_name','style','parent_id','level','detail','pic'],'string','on' => [ 'default','update']],
