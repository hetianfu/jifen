...
use api\modules\seller\service\wechat\FansStatService;
use Yii;
...
class StatController extends BaseController
{
    ...
    {
        parent::init();
        $this->service = new FansStatService();
    ...
    public function actionFansFollow()
    {
        ...
        if ($yesterdayModel =  $this->service->findByCreatedAt(strtotime(date('Y-m-d')) - 60 * 60 * 24)) {
        ...
        if ($todayModel =  $this->service->findByCreatedAt(strtotime(date('Y-m-d')))) {
