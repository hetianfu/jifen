 ...
 * 限时--TIMER
 * 促销--SALES;
 * @property int $status  状态 ，1生效，0未开始 -1已结束;
...
class SaleProductModel extends Base
{
    ...
    public function rules()
    {
        ...
        return array_merge([
            ...
            [['name', 'strategy_type', 'start_date', 'end_date'], 'string', 'on' => ['default', 'update']],
            [['status', 'start_hour', 'end_hour', 'show_order', 'limit_number'], 'integer', 'on' => ['default', 'update']],
            [['id', 'on_show'], 'safe', 'on' => ['default', 'update']],
