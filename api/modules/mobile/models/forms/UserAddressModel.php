 ...
 *  @property integer $is_default isDefault 是否默认地址
 */
class UserAddressModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['id','user_id','name','telephone','other_phone','city','city_code','lat','lng','street','room','detail','address_type','address_snap',],'string','on' => [ 'default','update']],
            [['is_default' ], 'integer','on' => [ 'default','update']],
        ], $rules);
    }
