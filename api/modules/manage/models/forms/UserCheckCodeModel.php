...
class UserCheckCodeModel extends Base{
    ...
    public function rules(){
        ...
        return array_merge([
            ...
            [['title', 'user_id','user_code','product_id','order_id','coupon_type','shop_id','check_shop_id','bar_qrcode',],'string','on' => [ 'default','update']],
    ...
    public function fields(){
        ...
        isset($this->detail)&&$fields['detail']='detail';
    ...
    public function getDetail(){
        return $this->hasMany( UserCheckCodeRecordModel::class,['order_id'=>'order_id'])->select(['id','order_id','number','check_employee_id','check_employee_name' ,'created_at']);
